...
| 11 | [phase-11-analytics.md](phase-11-analytics.md) | Events, dashboards, retention cron | **core done early** — retention cron route shipped (vercel.json daily) + Conversations page + AI questions feed; P11.T5 privacy note pending |
