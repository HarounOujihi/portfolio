...
- Earlier career highlights: AppliBtp (2019–2022, Genext-IT — modular BTP SaaS for construction-site management, web + React Native mobile: site operations, strong task management, quotes with client confirmation, procurement, equipment inventories — led the team). Printaura (2014–2016 — print-on-demand fulfillment automation: orders pulled from shops on eight commerce platforms (Etsy, Shopify, eBay, PrestaShop…), routed to partner factories and printers, status synced back — the precursor pattern of the MAHD connector framework). Odesco school management deployed across six schools. Ionic mobile apps at PagesQatar (Lentille, Jamally, Tamwin Online). First MAHD stint 2012–2013 — Tasswia point-of-sale and inventory systems in vb.NET.
- Client delivery: YouthToProfessionals (youthtoprofessionals.org — non-profit mentorship platform: mentor–mentee matching, programs (Mentorship Program, Coaching Program), workshops, events, become-a-mentor/mentee intake flows; Directus headless CMS + React Remix, built end to end for the client).
